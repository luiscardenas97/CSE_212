...
class Queue:
    ...
    def enqueue(self, value):
        ...
        """
        #self.queue.insert(0, value) #Error Found: It was adding the people at the front of the queue.
    ...
    def get_next_person(self):
        ...
        if self.people.is_empty():
            ...
            if person.turns > 1:  
                person.turns -= 1 
                self.people.enqueue(person)
            elif person.turns <= 0: #Error Found: It didn't enqueue again if the person has 0 or less turns.
                self.people.enqueue(person)
...
# Defect(s) Found: It was adding the people in the wrong order. The method enqueue was inserting every person always 
# at the front of the queue when it should be adding them to the back of the queue.
...
while len(players) > 0:
    players.get_next_person()
# Defect(s) Found: No specific defect was found in this part. It was been affected by the same error as the test 1.
...
for i in range(10):
    players.get_next_person()
#print(players)    
# Defect(s) Found: It didn't enqueued again people who had number of turns 0 or less.
...
players = Taking_Turns_Queue()
players.get_next_person()
# Defect(s) Found: No defect was found in this test. An error message was displayed.
    

#The part that was corrected was the method enqueue because it was adding people to the front of the queue instead 
# of to the back. The method get_next_person was also modified because it didn't enqueue again the people who had 0 or less turn.